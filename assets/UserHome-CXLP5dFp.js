const e = [
    { to: { name: "UserHome" }, iconName: "Common-Home", label: "HOME" },
    { to: { name: "UserAbout" }, iconName: "Common-About", label: "ABOUT" },
  ],
  i = [
    { id: "0", name: "EN" },
    { id: "1", name: "CH" },
  ...
  a = [
    { id: 1, name: "輕食", image: "food_Pescatora.png", count: 7 },
    { id: 2, name: "麵包", image: "food_Syokupan.png", count: 8 },
    { id: 3, name: "炸物", image: "food_Ebi_Fry.png", count: 6 },
    { id: 4, name: "甜點", image: "food_Tarte.png", count: 10 },
    { id: 5, name: "純茶", image: "food_Tea.png", count: 5 },
    { id: 6, name: "拿鐵", image: "food_Cafe.png", count: 5 },
    { id: 7, name: "那堤", image: "food_Milk.png", count: 6 },
    { id: 8, name: "冰沙", image: "food_Kakigoori.png", count: 3 },
  ],
  n = [
    {
      id: 1,
    ...
    },
    {
      ...
      name: "炸物",
      children: [
        { id: 1, name: "薯條", price: 45, image: "food_Fried.jpeg", count: 70 },
        {
          id: 2,
          name: "雙色地瓜球",
          price: 40,
...
export { i as a, n as b, a as c, e as h, m as o, g as p };
